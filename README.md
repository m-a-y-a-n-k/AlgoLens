...
**AlgoLens** is a comprehensive interactive visualization platform designed to demonstrate complex concepts in Computer Science, Mathematics, Physics, and Game Theory. It aims to bridge the gap between abstract theory and visual understanding for students, educators, and professionals.
...
### 🌌 Physics & Math
*   **Physics**: Solar System Simulation, Projectile Motion, Simple Harmonic Motion, Simple Pendulum, Rolling Motion, Circular Motion.
...
## 🛠️ Tech Stack
*   **Frontend**: React.js
*   **Styling**: Bootstrap 5, Styled Components, SCSS
*   **Visualization**: Three.js (@react-three/fiber), Chart.js
*   **Logic**: Math.js, Chess.js, worker-loader (for background processing)
